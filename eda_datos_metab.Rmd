...
Cargo los datos del estudio en formato *SummarizedExperiment*
...
Se observa que el 4-Imidazoleacetic Acid es el que guía la separación del grupo control hacia la izquierda, aunque no hay una gran diferencia respecto al resto de moleculas en el top 10.
